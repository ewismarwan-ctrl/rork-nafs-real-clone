        ...
        NavigationStack {
            List {
                Section("Worship Tools") {
                    moreRow(icon: "book.fill", title: NafsStrings.tabQuran.localized, subtitle: "Read Quran. Earn screen time from the Earn tab.", dest: .quran, premium: false)
                ...
                Section("Premium") {
                    moreRow(icon: "brain.head.profile", title: NafsStrings.tabNafsAI.localized, subtitle: "Use Nafs AI for discipline guidance.", dest: .nafsAI, premium: true)
                }
