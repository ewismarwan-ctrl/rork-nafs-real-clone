                ...
                ScrollView(.vertical, showsIndicators: false) {
                    ...
                    if !viewModel.isPremium && viewModel.showFreePlanBanner {
                        FreePlanBanner {
                            ...
                            viewModel.premiumGateBenefit = "Unlock Nafs Lock, earned screen time automation, and deeper discipline tools."
    ...
    private var headerSection: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("Earn your screen time. Worship first. Dopamine later.")
