...
struct EarnScreenView: View {
            ...
            ScrollView {
                VStack(spacing: 18) {
                    ...
                    earnActionCard(
                        ...
                        reward: HabitType.quran.screenTimeMinutes,
                    ...
                    earnActionCard(
                        ...
                        reward: HabitType.dhikr.screenTimeMinutes,
                    ...
                    earnActionCard(
                        ...
                        reward: DisciplineActionType.focusSessionCompleted.dopamineMinutes,
                        isComplete: false
                    ) {
                    ...
                    if viewModel.isPremium {
                        earnActionCard(
                            ...
                            reward: DisciplineActionType.muhasabahReflection.dopamineMinutes,
                            isComplete: false
                        ) {
    ...
    private func earnActionCard(icon: String, title: String, subtitle: String, reward: Int, isComplete: Bool, action: @escaping () -> Void) -> some View {
        Button(action: action) {
            HStack(spacing: 14) {
                ...
                Spacer()
                Text(isComplete ? "Done" : "+\(reward) min")
                    .font(.system(.caption, weight: .bold))
