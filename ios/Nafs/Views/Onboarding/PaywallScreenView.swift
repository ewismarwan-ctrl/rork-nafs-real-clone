                    ...
                    HStack(alignment: .top, spacing: 12) {
                        PaywallTierCard(
                            ...
                            features: [
                                ...
                                ("xmark", NafsStrings.dhikr.localized),
                                ("xmark", NafsStrings.appBlocker.localized),
                                ("xmark", NafsStrings.circles.localized),
                                ("xmark", NafsStrings.gardenOfDeeds.localized),
                                ("xmark", NafsStrings.guidedPlans.localized),
                                ("xmark", NafsStrings.muhasabah.localized),
                                ("xmark", NafsStrings.qiblaFinder.localized),
                            ],
                            isPremium: false
                        )
                        ...
                        PaywallTierCard(
                            ...
                            features: [
                                ...
                                ("checkmark", NafsStrings.sendDua.localized),
                                ("checkmark", NafsStrings.progress.localized),
                            ],
                            isPremium: true
                        )
                    }
