    ...
    var body: some View {
        ...
        ZStack(alignment: .bottom) {
            TabView(selection: $navigationState.selectedTab) {
                ...
                Tab("Earn", systemImage: "timer.badge.checkmark", value: .earn) {
                    EarnScreenView(viewModel: viewModel, storeViewModel: storeViewModel)
                        .safeAreaPadding(.bottom, isMiniBarVisible ? miniBarHeight : 0)
                }

                Tab("Lock", systemImage: "lock.shield.fill", value: .lock) {
...
enum AppTab: Hashable {
    case home, earn, lock, progress, more
}
        ...
        NavigationStack {
            List {
                Section("Worship Tools") {
                    ...
                    moreRow(icon: "moon.stars", title: NafsStrings.muhasabah.localized, subtitle: "Reflect. Reset. Rebuild.", dest: .muhasabah, premium: true)
                }
                ...
                Section("Account") {
                    actionRow(icon: "crown.fill", title: "Premium", subtitle: "Earned screen time automation and deeper discipline tools.") {
                        gateFeature = "Nafs Premium"
                        gateBenefit = "Unlock Nafs Lock, earned screen time automation, Nafs AI, and premium discipline tools."
                        showPremiumGate = true
                    }
                    moreRow(icon: "brain.head.profile", title: NafsStrings.tabNafsAI.localized, subtitle: "Discipline guidance without clutter.", dest: .nafsAI, premium: true)
                ...
                Section("Support") {
                    ...
                    actionRow(icon: "info.circle.fill", title: "About", subtitle: "Earn screen time through worship and discipline.") {
                        showInfo(title: "About Nafs", message: "Nafs helps Muslims earn screen time through worship and discipline.")
                    }
                }
...
enum MoreDestination: Hashable {
    case quran, dhikr, muhasabah, nafsAI, settings
}
